...
const events = [
  ...
  {
    time: "3:00 PM",
    title: "What Makes a Great Demo?",
    body: "Quick breakdown of what makes a demo land—clear structure, strong visuals, and confident delivery",
    icon: "fa-comments",
    color: "#38bdf8",
  ...
  },
  {
    ...
    body: "Each team gets 3 minutes to present and 2 minutes Q&A with judges. All participants are encouraged to watch.",
    icon: "fa-display",
    color: "#f97316",
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg,#04111f 0%,#061828 18%,#072035 42%,#082a45 66%,#093252 86%,#0a3860 100%)",
          paddingTop: "6rem",
          paddingBottom: "9rem",
        }}
      >
          ...
          {RAYS.map((r, i) => (
            <div
              ...
              style={{
                ...
                height: r.h,
                background:
                  "linear-gradient(to bottom,rgba(255,255,255,.2),transparent)",
        ...
        >
          {bgBubbles.map((b) => (
            <div
              key={b.id}
              className="sch3-bg-bubble absolute rounded-full"
              style={{
                width: b.size,
                height: b.size,
                left: b.left,
        ...
        />
        <img
          src="/images/seahorse-pink.png"
          alt=""
          className="sch3-float pointer-events-none absolute hidden lg:block"
          style={{
            zIndex: 4,
            left: "1.5%",
            top: "30%",
            ...
            opacity: 0.55,
            animationDelay: "2s",
            filter: "drop-shadow(0 0 14px rgba(236,72,153,.3))",
          }}
        />
        <img
          src="/images/seahorse-pink.png"
        ...
        <img
          ...
          alt=""
          className="sch3-glide pointer-events-none absolute hidden lg:block"
          style={{
            zIndex: 4,
            right: "2.5%",
            top: "36%",
        ...
        />
        <img
          src="/images/seahorse-yellow.png"
          alt=""
          className="sch3-glide pointer-events-none absolute hidden xl:block"
          style={{
            zIndex: 4,
            right: "1%",
            top: "56%",
            width: "min(122px,15vw)",
            opacity: 0.42,
            animationDelay: "3.5s",
            filter: "drop-shadow(0 0 16px rgba(56,189,248,.2))",
          }}
        />
        <img
          src="/images/fish-school.png"
          alt=""
          className="sch3-sway pointer-events-none absolute hidden md:block"
          style={{
            zIndex: 4,
            right: "2%",
            bottom: "14%",
        ...
        <img
          ...
          style={{
            ...
            opacity: 0.52,
            animationDelay: "5s",
            filter: "drop-shadow(0 0 14px rgba(234,179,8,.25))",
          }}
        />
        <img
          src="/images/octopus.png"
          alt=""
          className="sch3-float pointer-events-none absolute hidden xl:block"
          style={{
            zIndex: 4,
            left: "1.5%",
            top: "14%",
        ...
        <div
          ...
          style={{
            zIndex: 5,
            background:
              "radial-gradient(ellipse at 50% 0%,rgba(4,17,31,.03) 0%,rgba(4,17,31,.48) 88%)",
          }}
        />
          ...
          <div ref={headerRef} className="text-center mb-12">
            <div className="sch3-eyebrow mb-4 flex items-center justify-center gap-2">
              ...
              <span
                ...
                style={{ color: "#5ecfff" }}
              >
                <i className="fa-solid fa-calendar-days mr-2" aria-hidden />
                May 2nd Schedule
              </span>
              <span
                className="h-px w-10"
            ...
            <h2
              className="sch3-headline font-nature leading-[1.06] mb-4"
              style={{
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                      ...
                      >
                        <i
                          ...
                          style={{ color: e.color, fontSize: 15 }}
                          aria-hidden
                        />
                      </div>
                      ...
                      <div style={{ flex: 1 }}>
                        <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1 mb-1.5">
                          <span
                            className="font-nature"
                            style={{
                              fontSize: "clamp(1rem,2.5vw,1.25rem)",
                              lineHeight: 1.2,
                              color: e.highlight ? "#e8fbff" : e.color,
                              textShadow: e.highlight
                                ? `0 0 20px ${e.glow}`
                                : "none",
                            }}
                          >
                          ...
                          <div className="flex flex-wrap items-center gap-1.5">
                            <span
                              className="font-body text-xs px-2.5 py-0.5 rounded-full font-medium"
                              style={{
                        ...
                        <p
                          ...
                          style={{ color: "rgba(186,230,252,.65)" }}
                        >
                          {e.body}
                        </p>
                      </div>
        ...
        >
          ...
          >
            <path
              d="M0,50 C240,100 480,5 720,50 C960,95 1200,10 1440,50 L1440,100 L0,100 Z"
              fill="#06182a"
            />
          </svg>
        </div>
