    ...
    >
      ...
      <div
        ...
        style={{
          zIndex: 5,
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(7,30,51,0.1) 0%, rgba(7,30,51,0.65) 80%)",
        }}
      />
      ...
      >
        {jellies.map((j, i) => (
          <img
            ...
            style={{
              width: `clamp(${j.mobileW}px, ${Math.round(j.w / 14)}vw, ${j.w}px)`,
              height: "auto",
              ...j.style,
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(105deg, rgba(3,105,161,0.45) 0%, rgba(2,60,100,0.35) 100%)",
            border: "1px solid rgba(56,189,248,0.5)",
            backdropFilter: "blur(12px)",
            boxShadow:
              "0 0 24px rgba(14,165,233,0.15), inset 0 1px 0 rgba(255,255,255,0.12)",
          }}
        >
          <i
            className="fa-solid fa-calendar-days shrink-0 text-xs text-aqua-mid"
            aria-hidden
          />
          <span
            ...
            style={{
              ...
              textShadow:
                "0 1px 12px rgba(0,0,0,0.45), 0 0 20px rgba(56,189,248,0.25)",
            }}
          >
            May 2nd, 2026
          </span>
        ...
        <div className="hero-reveal-item mb-10 flex w-full flex-col items-center">
          <p className="mb-4 flex items-center justify-center gap-2 font-body text-xs uppercase tracking-[0.2em] text-aqua-light/60">
            <img
              ...
              alt=""
              style={{ height: 22, width: "auto", display: "inline" }}
            />
        ...
        <div className="hero-reveal-item flex flex-col items-center gap-5 sm:flex-row sm:gap-6">
          ...
          >
            ...
            <span className="btn-ocean-cta__label">
              Register now;it&apos;s free
            </span>
          </a>
          <a
            href="#about"
            className="btn-ocean-cta btn-ocean-cta--bubble-secondary text-base"
          >
            {/* <img className="btn-ocean-cta__bubble" src="/images/jelly-pink.png" alt="" aria-hidden /> */}
            <i
              className="fa-solid fa-compass btn-ocean-cta__icon"
              aria-hidden
            />
            <span className="btn-ocean-cta__label">
              Learn what awaits below
            </span>
          </a>
        </div>
      </div>
