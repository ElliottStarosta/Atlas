...
const CREATURES = [
  {
    ...
    cls: 'jelly-float',
    style: { width: 200, right: '3%', top: '10%' },
    delay: '0s',
  },
  {
...
export default function WhyJoin() {
  ...
  const handleMouseMove = (e, i) => {
    ...
    gsap.to(card, {
      rotateX: -dy * 6, rotateY: dx * 6, scale: 1.03,
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, #071e33 0%, #0c4a6e 45%, #071e33 100%)' }}
    >
        ...
        {AMBIENT_BUBBLES.map((b) => (
          <div
            ...
            style={{
              ...
              background: 'radial-gradient(circle at 35% 28%, rgba(255,255,255,0.2), transparent 65%)',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div ref={headerRef} className="text-center mb-20" style={{ opacity: 0 }}>
          ...
          <h2 className="font-nature text-4xl sm:text-5xl lg:text-6xl text-sky-blue mb-5 leading-tight">
            Dive in{' '}
            <span className="text-gradient-ocean">head‑first.</span>
          </h2>
          <p className="text-aqua-light/70 font-body text-lg max-w-2xl mx-auto leading-relaxed">
            ATLAS isn't just a competition. It's 12 hours that can change how you see what you're capable of.
          </p>
        </div>
          ...
          {reasons.map((r, i) => (
            ...
            >
              ...
              <div className="wj-card__orb mb-5">
                <i className={`fa-solid ${r.icon} text-xl`} style={{ color: r.color }} />
              </div>

              <h3 className="font-nature mb-3 leading-snug" style={{ color: r.color, fontSize: '1.5rem' }}>
                {r.title}
              </h3>
              <p className="font-body text-sm leading-relaxed" style={{ color: 'rgba(186,230,252,0.68)' }}>
                {r.body}
              </p>
