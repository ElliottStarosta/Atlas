...
const checklist = [
  {
    ...
    body: "A power strip makes you a legend at the table.",
  },
  {
    icon: "fa-utensils",
    title: "Skip the snacks",
    body: "We feed the fleet;flag allergies on the signup form.",
  },
  {
    icon: "fa-microphone",
    title: "A clear story",
    body: "Judges reward a crisp demo in minutes, not a tour of every file.",
  },
  {
    icon: "fa-users",
    title: "Your crew",
    body: "Up to 3 per team;all skill levels welcome.",
  },
];
  ...
  box-shadow:
    ...
    0 0 44px rgba(56,189,248,0.3);
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg,#06182a 0%,#071e35 15%,#082840 35%,#093354 60%,#0a3f66 85%,#0c4a6e 100%)",
          paddingBottom: 0,
        }}
      >
        {/* Caustic light */}
        ...
        >
          ...
          <img
            ...
            alt=""
            className="ab-jelly-b absolute hidden sm:block"
            style={{
              left: "2%",
              top: "38%",
              width: "min(80px,16vw)",
              opacity: 0.65,
              filter: "drop-shadow(0 0 14px rgba(236,72,153,.30))",
            }}
          />
          <img
            ...
            style={{
              ...
              width: "min(90px,15vw)",
              opacity: 0.7,
              filter: "drop-shadow(0 0 16px rgba(234,179,8,.25))",
            }}
          />
        </div>
        ...
        >
          {riseBubbles.map((b) => (
            <div
              key={b.id}
              className="ab-bubble absolute rounded-full"
              style={{
                width: b.size,
                height: b.size,
                left: `${b.left}%`,
                ...
                "--bx": b.bx,
                background:
                  "radial-gradient(circle at 35% 28%,rgba(255,255,255,.5),transparent 62%)",
        ...
        <div
          ...
          style={{
            zIndex: 3,
            background:
              "radial-gradient(ellipse at 50% 0%,rgba(6,24,42,.05) 0%,rgba(6,24,42,.55) 85%)",
          }}
        />

        {/*  CONTENT  */}
        <div
          className="relative mx-auto max-w-6xl px-4 pt-16 pb-24 sm:px-6 sm:pt-20 lg:pt-28 lg:pb-32"
          style={{ zIndex: 10 }}
        >
          <div className="ab-eyebrow mb-4 flex items-center gap-2">
            <span
              ...
              style={{
                background:
                  "linear-gradient(to right,transparent,rgba(56,189,248,.5))",
              }}
            />
            <span
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(to left,transparent,rgba(56,189,248,.5))",
              }}
            />
          </div>

          <h2
            className="ab-headline font-nature text-center leading-[1.06] mb-5"
            style={{
          ...
          <p
            className="ab-body font-body text-center mx-auto max-w-2xl text-base leading-relaxed sm:text-lg mb-14"
            style={{ color: "rgba(224,247,255,.85)" }}
          >
            ATLAS is Earl of March's flagship hackathon, a 12-hour sprint where
            Kanata students team up, sketch ideas, argue about stack choices,
            and turn rough concepts into something demoable by nightfall. Open
            to everyone: first-timers, veterans, designers, and wildcards alike.
          </p>
          ...
          <div className="mb-16 flex flex-wrap justify-center gap-3 sm:gap-4">
            {stats.map((s) => (
              ...
              >
                <i
                  className={`fa-solid ${s.icon} text-xs text-aqua-mid`}
                  aria-hidden
                />
                <span
                  ...
                  style={{
                    ...
                    lineHeight: 1,
                    textShadow: "0 0 16px rgba(56,189,248,.3)",
                  }}
                >
                  {s.value}
                </span>
                <span className="font-body text-xs text-aqua-light/70">
                  {s.label}
                </span>
              </div>
            ))}
          ...
          <div className="grid gap-5 lg:grid-cols-2 lg:gap-6">
            {/* Left card */}
            <div
              className="ab-card-left relative overflow-hidden rounded-3xl p-6 sm:p-8 flex flex-col justify-between"
              style={{
                background:
                  "linear-gradient(145deg,rgba(3,80,140,.45) 0%,rgba(4,18,34,.88) 100%)",
                border: "1px solid rgba(56,189,248,.3)",
                boxShadow:
                  "inset 0 1px 0 rgba(255,255,255,.12),0 8px 32px rgba(0,0,0,.25)",
                minHeight: 320,
              }}
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse 70% 45% at 30% 12%,rgba(255,255,255,.12) 0%,transparent 55%)",
                }}
              />
              <div
                className="pointer-events-none absolute -top-12 -left-12 w-56 h-56 rounded-full"
                style={{
                  background:
                    "radial-gradient(circle,rgba(56,189,248,.18) 0%,transparent 65%)",
                  opacity: 0.6,
                }}
              />
              {[
                ...
                <div
                  key={i}
                  className="ab-bubble pointer-events-none absolute rounded-full"
                  style={{
                    width: b.s,
                    height: b.s,
                    left: b.l,
                    ...
                    "--bx": "2px",
                    background:
                      "radial-gradient(circle at 36% 30%,rgba(255,255,255,.5),transparent 62%)",
              ...
              <div className="relative z-10">
                <div className="mb-5 flex items-center gap-2.5">
                  <span
                    className="flex h-8 w-8 items-center justify-center rounded-full border border-sky-400/40"
                    style={{ background: "rgba(3,105,161,.5)" }}
                  >
                    <i
                      className="fa-solid fa-hourglass-half text-xs text-aqua-mid"
                      aria-hidden
                    />
                  </span>
                ...
                <p
                  className="font-nature leading-[1.08] mb-4"
                  style={{
                ...
                >
                  You argue about the idea for exactly as long as it deserves,
                  then you build. When something breaks you cut it and keep
                  moving. By nightfall you've shipped something real -- rough edges
            ...
            <div className="flex flex-col gap-5">
              <div
                className="ab-card-checklist relative rounded-3xl p-6 sm:p-7 flex-1"
                style={{
                  background:
                    "linear-gradient(150deg,rgba(3,65,110,.38) 0%,rgba(4,18,34,.85) 100%)",
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse 65% 40% at 80% 8%,rgba(255,255,255,.09) 0%,transparent 55%)",
                  }}
                />
                <img
                ...
                <div className="relative z-10">
                  <div className="mb-5 flex items-center gap-2.5">
                    ...
                    >
                      <i
                        className="fa-solid fa-bag-shopping text-xs text-aqua-mid"
                        aria-hidden
                      />
                    </span>
                    <span className="font-body text-xs font-semibold uppercase tracking-[0.24em] text-aqua-light/55">
                  ...
                  <ul className="space-y-3.5 font-body">
                    {checklist.map((item, i) => (
                      <li
                        key={i}
                        className="ab-checklist-item flex gap-3.5 items-start"
                      >
                        <span
                          className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-sky-400/25"
                          style={{ background: "rgba(3,105,161,.38)" }}
                        >
                          <i
                            className={`fa-solid ${item.icon} text-[11px]`}
                            style={{ color: "rgba(56,189,248,.85)" }}
                            aria-hidden
                          />
                        </span>
                        <div>
                          <span
                            ...
                            style={{ color: "rgba(220,247,255,.9)" }}
                          >
                            {item.title}
                          </span>
                          <span
                            className="block text-xs leading-relaxed mt-0.5"
                            style={{ color: "rgba(125,211,252,.6)" }}
                          >
                            {item.body}
                          </span>
                        </div>
              ...
              <div
                className="ab-card-cta relative overflow-hidden rounded-3xl p-6 sm:p-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6"
                style={{
                  background:
                    "linear-gradient(130deg,rgba(2,55,100,.55) 0%,rgba(4,14,28,.92) 100%)",
                  border: "1px solid rgba(56,189,248,.4)",
                  boxShadow:
                    "inset 0 1px 0 rgba(255,255,255,.14),0 0 40px rgba(14,165,233,.10)",
                }}
              >
                <div
                  className="pointer-events-none absolute inset-0 rounded-3xl"
                  style={{
                    background:
                      "radial-gradient(ellipse 75% 60% at 10% 50%,rgba(56,189,248,.1) 0%,transparent 60%)",
                  }}
                />
                <div className="relative z-10 min-w-0">
                  <p
                    className="font-nature leading-tight mb-1"
                    style={{
                      fontSize: "clamp(1.3rem,2.8vw,1.7rem)",
                      color: "#e8fbff",
                      textShadow: "0 0 24px rgba(14,165,233,.3)",
                    }}
                  >
                    Spots fill fast.
                  </p>
                ...
                <a
                  ...
                  className="btn-ocean-glass text-sm w-full sm:w-auto text-center"
        ...
        <div
          ...
          style={{ zIndex: 12 }}
        >
          {/* Two-layer wave: front layer fills the target section colour,
              back layer is slightly offset to give depth */}
          <svg
          ...
          >
            {/* Back wave;lighter tint, slightly behind */}
            <path
              d="M0,60 C180,20 360,100 540,55 C720,10 900,90 1080,45 C1260,5 1350,65 1440,40 L1440,110 L0,110 Z"
              fill="rgba(7,30,51,0.45)"
            />
            {/* Front wave;solid target colour, carries the section transition */}
            <path
              d="M0,75 C240,30 420,110 660,62 C840,28 1020,95 1200,52 C1320,24 1400,72 1440,58 L1440,110 L0,110 Z"
              fill="#071e33"
            />
          </svg>
        </div>
